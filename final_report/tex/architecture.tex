...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|X|X|}
		...
		Advisor					& The advisor is Mohsen Anvaari. His job is to act as a guide and supporting the team.  \\ \hline
...
\paragraph{Advisor:} The groups advisor is Mohsen Anvaari. He will give feedback and guide the developers on all areas. This will be done by giving feedback and help us create a good documentation, and help us with any issues we might have that does not concern the client.
