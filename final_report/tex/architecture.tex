...
This sequence diagram, shown in \figref{fig:SequenceDiagram2}, is mostly the same as the previous one, which was \figref{fig:SequenceDiagram1}. The only difference is that it contains one additional, calculation, which calculates the positions of the sensors according to the link budget.
\begin{figure}[H]
	\centering
