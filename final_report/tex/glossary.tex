...
{
   name=DASH7,
   description={DASH7 is an open source protocall for wireless sensor networking. The signal operates in 433MHz. The range of the signal can go all the way up to 2km with an accuracy of 1m, it has low latency for connecting with moving things. All these attributes makes it the perfect candidate for our sensors.}
}

\newglossaryentry{Android}
{
   name=Android,
   description={Android is a mobile operation system based on linus made by Google. It is made with touchscreen smart mobile devices in mind such as smartphones and tablets.}
}
