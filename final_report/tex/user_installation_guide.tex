...
\item Connecting the central hub to the network

\item Setting up the database
\item Connecting the database to the network

\item Configuring the visualiser
\item Connecting the visualiser to the network

\item Running the central hub
\item Configuring the central hub
