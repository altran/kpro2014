...
When using the sensors, we would have a raspberry pi acting as a server. In this case our client requests information from the server, and stores it in a database of some sort. Then our visualiser uses this data to show it in a visual way. \figref{fig:Architecture_1} illustrates this architecture.
