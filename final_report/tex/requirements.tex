...
\\ \hline 1.2
&Pull data
&The visualizer can pull data out of the database, the data format we are pulling out will be in json format (dash7 is very simlilar to json).
\\ \hline 
\end{tabularx}
\end{table}
...
\\ \hline 2.3
&Process data 
&The central hub will process data into the form the visualizer needs, meaning sort the dash7 into json.
\\ \hline 2.4
&Support hotjoin
