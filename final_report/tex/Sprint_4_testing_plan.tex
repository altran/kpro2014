...
\begin{itemize}
	...
	\begin{itemize}
		\item
		The visualiser needs the gateway formula to place the gateway at the beginning of runtime.
		\item
		The visualiser needs the weight formula to animate sensor movements during runtime.
	\end{itemize}
	\item
	Constants to visualiser
	\begin{itemize}
		\item
		The visualiser will take the constants configured by the administrator through a text document.
	\end{itemize}
	\item
	\gls{DASH7} data generator to database
	\begin{itemize}
...
\begin{tabularx}{\textwidth}{|L{2cm}|l|L{2.2cm}|X|}
	...
	&T8
	&5.1, 5.1.1
	&Generate multiple gateways on the visualiser and the number of gateways should be configurable. They will all be placed in a geometric shape, that will reflect a perfect setup.
	\\ \hline Link budget
	&T9
	&5.2, 5.2.1, 5.2.2, 5.2.3, 5.2.4
	&The visualiser will use a link budget value as weights in our formula to animate the position of sensors. This will also consider most of real life cases like going behind a wall or go to a different room.
	\\ \hline Calibration
	&T10
	&5.2.5
