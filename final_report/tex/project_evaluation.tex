...
We estimated that the whole project would take 2150 hours to complete, in the end we calculated that we had used ?? (Most likely 1950) hours on this project. A detailed overview of the time can be found in this subsection, both in textual format and as a table in \tableref{tab:time_estimate}
