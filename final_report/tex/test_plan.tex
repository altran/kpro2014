...
We do not have a huge user base to test due to our lack of time and resource. Therefore most of our user test was done inside the team, with customer and advisor as the only two outsider person who have seen our program so far. Although this is not enough to say if our UI is good or not but it gav us a lot of help during the developement when something is wrong.
