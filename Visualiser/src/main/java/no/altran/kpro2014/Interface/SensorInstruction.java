...
/**
 * This class extends the Instruction interface to make a SensorInstruction that has information of sensorID, lighting
 * data, when it should start to be rendered, how long the animation gonna last, where the image is gonna
